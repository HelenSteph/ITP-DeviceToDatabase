...
image::images/rule-no-rules.png[]

Name the rule `environment`

image::images/rule-create.png[]
...
image::images/rule-action-split-dynamo-v2.png[]
...
image::images/rule-dynamo-items.png[]

image::images/rule-dynamo-edit.png[]
